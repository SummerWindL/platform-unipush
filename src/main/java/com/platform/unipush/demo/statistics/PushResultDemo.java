package com.platform.unipush.demo.statistics;
...
public class PushResultDemo {
    ...
    public static void main(String[] args) {
        getPushResultByTaskId("OSA-0601_F062NMuAUb80fctbwdOvw8");
//        getPushResultByTaskidList();
//        getPushResultByGroupName("别名");
//        queryAppPushDataByDate("20200601");
    }
     ...
     * @param taskId
     */
    public static void getPushResultByTaskId(String taskId) {
     ...
     */
    public static void queryAppPushDataByDate(String date) {
